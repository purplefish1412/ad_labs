...
plot.border_fill_color = "#cfe2f3"

# Генерація гармоніки
harmonic_line = plot.line(t, harmonic(t, initial_amplitude, initial_frequency, initial_phase), line_width=2, color='#cfe2f3', line_dash='dotted', legend_label='Harmonic line')
...
with_noise_line = plot.line(t, harmonic_with_noise(t, initial_amplitude, frequency=initial_frequency,
                                                   ...
                                                   line_width=2, color='#81a9d9', legend_label='Signal with noise')
...
l_filtered = plot.line(t, filtered_signal, line_width=2, color='#235c8d', legend_label='Filtered Signal')
